# Lista de verificación de calidad de la especificación: Alta de propiedades
...
- [x] La especificación define el alta sin imagen y con imagen opcional
- [x] La especificación define validaciones para formato y tamaño de imagen

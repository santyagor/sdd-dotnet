# Lista de verificación de calidad de la especificación: Consulta de propiedad por id
...
- [x] No contiene detalles de implementación innecesarios
...
- [x] La especificación define la respuesta exitosa para un id existente
- [x] La especificación define el comportamiento para id inexistente e id inválido
- [x] La especificación define el criterio de `imageUrl` pública absoluta
